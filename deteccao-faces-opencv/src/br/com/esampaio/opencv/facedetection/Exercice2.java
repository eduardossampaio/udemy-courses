...
//		Mat imgage = Imgcodecs.imread("pessoas/beatles.jpg");
		...
		CascadeClassifier faceCascadeClassifier  = new CascadeClassifier("cascades/haarcascade_frontalface_default.xml");
		...
		//detecção de olhos
		CascadeClassifier eyeCascadeClassifier  = new CascadeClassifier("cascades/haarcascade_eye.xml");
		MatOfRect detectedEyes = new MatOfRect();
		eyeCascadeClassifier.detectMultiScale(
				grayedImage, 
				detectedEyes);
		
		System.out.println("detected eyes: "+detectedEyes.toArray().length);
